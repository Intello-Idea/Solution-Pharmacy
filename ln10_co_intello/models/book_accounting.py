...
class Book(models.Model):
    ...
    _sql_constraints = [
        ('id_book_Unique', 'UNIQUE(id_book)', "you can't have two books with the same id!"),
        ('id_book_Initials', 'UNIQUE(initials)', "you can't have two books with the same initials!")]
...
class MultiBookAccounting(models.Model):
    ...
    _sql_constraints = [
        ('id_count_account_base', 'UNIQUE(count_account_base)', "you can't have two books with the same initials!")]
...
class OwnAccounts(models.Model):
    ...
    _sql_constraints = [
        ('id_book_Detail_own', 'UNIQUE(accounting_account)', "This own account is already being used by another book")]
